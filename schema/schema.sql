...
CREATE TABLE Tags (
	...
	tag_owner		VARCHAR(500)	NOT NULL CONSTRAINT valid_tag_owner_required REFERENCES organizations(org_name),
	tag_active		BIT	 DEFAULT 1,
	CONSTRAINT unique_tag_required_per_organization UNIQUE(tag_title,tag_owner)
);
...
CREATE TABLE Contacts (
	...
	contact_owner		VARCHAR(500)	NOT NULL CONSTRAINT contact_organization_owner_required REFERENCES organizations( org_name ),
	contact_identification		VARCHAR(35)	 ,
	contact_gender		VARCHAR(2)	 ,
	contact_county		VARCHAR(45)	 ,
	contact_address		TEXT	 ,
	contact_birthday		DATETIMEOFFSET	 ,
	contact_date		DATETIMEOFFSET	 DEFAULT GETDATE(),
	contact_added_by		BIGINT	 CONSTRAINT valid_contact_manager_required REFERENCES members(member_id),
	contact_active		BIT	 DEFAULT 1,
	CONSTRAINT unique_contact_per_owner UNIQUE(contact_phone_number,contact_owner)
);
...
CREATE TABLE Recipients (
	...
	recipient_created		DATETIMEOFFSET	 DEFAULT GETDATE(),
	recipient_owner		BIGINT	NOT NULL CONSTRAINT valid_recipient_owner_required REFERENCES members(member_id),
	recipient_active		BIT	 DEFAULT 1
);

 --@ MESSAGE_TYPES 
CREATE TABLE Message_types (
	message_type_id		bigint   identity(1, 1)  PRIMARY KEY	 ,
	message_type_command		VARCHAR(50)	NOT NULL 
);
...
CREATE TABLE Campaigns (
	...
	campaign_senderid		VARCHAR(500)	NOT NULL CONSTRAINT valid_campaign_sender_id_required REFERENCES organizations(org_name),
	campaign_owner		BIGINT	NOT NULL CONSTRAINT valid_campaign_owner_required REFERENCES members(member_id),
	campaign_recipients		BIGINT	NOT NULL CONSTRAINT valid_campaign_recipient_list_required REFERENCES recipients(recipient_id),
	campaign_validity		BIGINT	 DEFAULT 0,
	campaign_message		TEXT	NOT NULL ,
	campaign_message_type		BIGINT	NOT NULL CONSTRAINT valid_campaign_message_type_required REFERENCES message_types(message_type_id),
	campaign_units		BIGINT	NOT NULL ,
	campaign_cost		DECIMAL	NOT NULL ,
	campaign_starts		DATETIMEOFFSET	NOT NULL ,
	campaign_ends		DATETIMEOFFSET	NOT NULL ,
	campaign_days		text	NOT NULL ,
	campaign_active		BIT	 DEFAULT 1,
	campaign_created		DATETIMEOFFSET	 DEFAULT GETDATE(),
	CONSTRAINT unique_campaign_name_required_per_senderid UNIQUE(campaign_name,campaign_senderid)
);
...
CREATE TABLE Templates (
	...
	template_senderid		VARCHAR(500)	NOT NULL CONSTRAINT valid_template_sender_id_required REFERENCES organizations(org_name),
	template_owner		BIGINT	 CONSTRAINT valid_template_owner_required REFERENCES members(member_id),
	template_created		DATETIMEOFFSET	 DEFAULT GETDATE(),
	template_active		BIT	 DEFAULT 1,
	CONSTRAINT unique_template_name_per_senderid UNIQUE(template_name,template_senderid)
);

 --@ CONTACT_TAGS 
CREATE TABLE Contact_tags (
	contact_tag_id		bigint   identity(1, 1)	 PRIMARY KEY,
	contact_tag_contact		BIGINT	NOT NULL CONSTRAINT valid_contact_required REFERENCES contacts(contact_id),
	contact_tag_tag		BIGINT	NOT NULL CONSTRAINT valid_tag_required REFERENCES tags(tag_id),
	contact_tag_active		BIT	 DEFAULT 1,
	CONSTRAINT unique_contact_required_per_tag UNIQUE(contact_tag_contact,contact_tag_tag)
);
